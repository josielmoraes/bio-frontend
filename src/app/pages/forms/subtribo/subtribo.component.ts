import { TriboData, Subtribo, SubtriboData } from "./../../../@core/data/tribo";
...
@Component({
  selector: "ngx-subtribo",
  templateUrl: "./subtribo.component.html",
  styleUrls: ["./subtribo.component.scss"],
})
export class SubtriboComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  public edit(object): void {
    this.subtribo = object;

    this.form.setValue({
      id: object.id_subtribo,
      nome: object.nome,
      tribo: object.tribo,
    });
  }
  ...
  public delete(object): void {
    Swal.fire({
      ...
      if (result.value) {
        this.service.deleteData(Number(object.id_subtribo)).subscribe(
          (): void => {
