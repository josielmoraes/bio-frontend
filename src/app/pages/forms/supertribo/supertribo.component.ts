import { Supertribo, SupertriboData } from "./../../../@core/data/tribo";
...
@Component({
  selector: "ngx-supertribo",
  templateUrl: "./supertribo.component.html",
  styleUrls: ["./supertribo.component.scss"],
})
export class SupertriboComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  constructor(
    ...
    private service: SupertriboData,
  ...
  public edit(object): void {
    this.supertribo = object;
    this.form.setValue({
      id: object.id_supertribo,
      nome: object.nome,
  ...
  public async submitHandler(): Promise<any> {
    ...
    if (typeof this.form.value.subfamilia !== "object" || this.form.value.subfamilia == "") {
  ...
  public delete(object): void {
    Swal.fire({
      ...
      if (result.value) {
        this.service.deleteData(Number(object.id_supertribo)).subscribe(
          (): void => {
