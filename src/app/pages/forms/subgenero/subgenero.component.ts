import { Subgenero, GeneroData, SubgeneroData } from "./../../../@core/data/genero";
...
@Component({
  selector: "ngx-subgenero",
  templateUrl: "./subgenero.component.html",
  styleUrls: ["./subgenero.component.scss"],
})
export class SubgeneroComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  public edit(object): void {
    this.subgenero = object;
    this.form.setValue({
      id: object.id_subgenero,
      nome: object.nome,
  ...
  public async submitHandler(): Promise<any> {
    this.submitted = true;
    if (typeof this.form.value.genero !== "object" || this.form.value.genero == "") {
      this.form.value.genero = null;
    }
  ...
  public delete(object): void {
    Swal.fire({
      ...
      if (result.value) {
        this.service.deleteData(Number(object.id_subgenero)).subscribe(
          (): void => {
